...
#DELETE 26.11.2022: safeguarding$Area <- recodeArea(DF=safeguarding,varname="Area",varname2="Site",varname3 = "LA.of.residence", varname4="Referred.from",varname5="Default.LA")
safeguarding$Area <- recodeArea(DF=safeguarding,varname="Area",varname1 = "Default.LA")
...
table(SelectedColumns$Dispatched.at.month.year == v1)
