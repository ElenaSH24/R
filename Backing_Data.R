...
setwd("~/Reports/1.Monthly_Reports/Performance_Reports/2023/2023_04")
...
orders = read.csv("20230502_sti_order_report.csv")


Treatments = read.csv("20230502_CT_Treatments.csv")
COC = read.csv("20230502_COC.csv")
POP = read.csv("20230502_POP.csv")
ECFuture = read.csv("20230511_ECFuture.csv")
ECNow = read.csv("20230511_ECNow.csv")
PhotoConsult = read.csv("20230502_PD_consultations.csv")
PhotoTreatm = read.csv("20230502_PD_treatments.csv")
Injectable = read.csv("20230502_Injectable.csv")
Patch = read.csv("20230502_Patch.csv")  
Ring = read.csv("20230502_Ring.csv")


# Invoicing data set from sti_invoice_detail.sql query
invSTI = read.csv("20230502_sti_invoicing_primary.csv")
# bolt-ons data for invoicing
bolts = read.csv("20230502_Combined_BoltOns.csv")
...
write.table (freetesting4, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023.04 freetesting.PHE.ImpactPrEP.csv", row.names=F, sep=",")
...
Data_Ireland$Site = NULL

write.table (Data_Ireland, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023.05.02_Ireland_STI.csv", row.names=F, sep=",")
# END Ireland Justin----



#export data to csv (export the data of the ordered file). Use double \\ when setting destination file----
write.table (Data_Berkshire, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Berkshire STI.csv", row.names=F, sep=",")
write.table (Data_Bromley, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Bromley STI.csv"
             , row.names=F, sep=",")

write.table (Data_Buckinghamshire, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Buckinghamshire STI.csv", row.names=F, sep=",")

write.table (Data_Cornwall, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Cornwall_Southe_Blackb STI.csv", row.names=F, sep=",")


write.table (Data_DerbyshireDerby, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month DerbyshireDerby STI.csv", row.names=F, sep=",")
write.table (Data_Dorset, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Dorset STI.csv", row.names=F, sep=",")
write.table (Data_Essex, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Essex STI.csv", row.names=F, sep=",")
write.table (Data_Thurrock, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Thurrock STI.csv", row.names=F, sep=",")
write.table (Data_Hillingdon, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Hillingdon STI.csv", row.names=F, sep=",")
write.table (Data_LLR.MPFT, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month LLR.MPFT STI_Hep.csv", row.names=F, sep=",")
write.table (Data_NIreland, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month NIreland STI.csv", row.names=F, sep=",")
write.table (Data_Worces_Hereford, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Worces_Hereford STI.csv", row.names=F, sep=",")
...
write.table (Treatment.Berkshire, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Berkshire Treatments.csv", row.names=F, sep=",")
write.table (Treatment.Bromley, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Bromley Treatments.csv", row.names=F, sep=",")
write.table (Treatment.DerbyshireDerby, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month DerbyshireDerby Treatments.csv", row.names=F, sep=",")
write.table (Treatment.Dorset, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Dorset Treatments.csv", row.names=F, sep=",")
write.table (Treatment.Essex, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Essex Treatments.csv", row.names=F, sep=",")
write.table (Treatment.Thurrock, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Thurrock Treatments.csv", row.names=F, sep=",")
write.table (Treatment.LLR.MPFT, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month LLR.MPFT Treatments.csv", row.names=F, sep=",")
write.table (Treatment.NIreland, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month NIreland Treatments.csv", row.names=F, sep=",")
...
# done via separate queries since Oct.2022
            ...
            #                    ,"Dispatched.at","Dispatched.at.month.year","Months.prescribed","Clinic","Region","LSOA.name")]
            # 
            # write.table (COC_Dorset, file="~/Reports/1.Monthly_Reports/Invoicing/2022/2022_10/BackingData/2022 Month Dorset COC.csv", row.names=F, sep=",")
            # write.table (POP_Dorset, file="~/Reports/1.Monthly_Reports/Invoicing/2022/2022_10/BackingData/2022 Month Dorset POP.csv", row.names=F, sep=",")
...
write.table (COC_DerbyshireDerby, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month DerbyshireDerby COC.csv", row.names=F, sep=",")
write.table (POP_DerbyshireDerby, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month DerbyshireDerby POP.csv", row.names=F, sep=",")
...
write.table (COC_LLR.MPFT, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month LLR.MPFT COC.csv", row.names=F, sep=",")
write.table (POP_LLR.MPFT, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month LLR.MPFT POP.csv", row.names=F, sep=",")
write.table (COC_Cornwall, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Cornwall_Southe_Blackb COC.csv", row.names=F, sep=",")
write.table (POP_Cornwall, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month Cornwall_Southe_Blackb POP.csv", row.names=F, sep=",")
# End Backing Data CONTRACEPTION ----


# Invoicing backing data Essex, Worcestershire ----
...
invSTIWorcest <- invSTI[(invSTI$default_la == 'Worcestershire'),]
invSTIWorcest$MonthYear <- as.Date(invSTIWorcest$processed_at, "%Y-%m-%d")
invSTIWorcest$MonthYear <- format(as.Date(invSTIWorcest$MonthYear), "%Y-%m")
invSTIWorcestMonth <- invSTIWorcest[(invSTIWorcest$MonthYear == v1), c("overall_type","default_la","repeat_kit","processed_at","MonthYear","invoice_category_all","invoice_category_billable")]  

write.table (invSTIessexThurrMonth, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month invoic_EssexThurrock.csv", row.names=F, sep=",")
write.table (invSTIWorcestMonth, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2023 Month invoic_Worcestershire.csv", row.names=F, sep=",")
...
Treatment_Bucks <- TreatmentsMerge [(TreatmentsMerge$Region=="Buckinghamshire"), 
                                    c("SH24.UID","customer_id",'Site','Area',"created_at","offered_at","prescription_at","dispatched_at","Notified.at")]
write.table (Data_Bucks, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_01/BackingData/2023.01.26 Bucks_NegarSTI.csv", row.names=F, sep=",")
...
write.table (Data_RoyalLiverpool2, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_04/BackingData/2022.10_RoyalLiverpool.csv", row.names=F, sep=",")
...
Herts <- orders[(orders$Default.LA=="Hertfordshire" | orders$Default.LA=="Freetesting - Hertfordshire"),]
write.table (Herts, file="~/Reports/1.Monthly_Reports/Invoicing/2022/2022_12/BackingData/2023.01.26_Herts_Sarah.csv", row.names=F, sep=",")
...
# 2023.02
Worces <- orders [(orders$Default.LA=="Worcestershire"),]
Worces2022 <- Worces[grep('2022', Worces$Lab.results.at),]

table(Worces2022$Postcode)
WorcesWR9 <- Worces[(Worces$Postcode == "WR9" | Worces$Postcode == "wr9"),]

WorcesWR92022 <- Worces2022[grep('wr9|WR9', Worces$Postcode),]
table(WorcesWR92022$Syphilis, WorcesWR92022$Lab.results.at.month.year)
table(WorcesWR92022$Gonorrhoea)

# 2023.04018 Negar Rotherham
Rotherham <- orders
Rotherham <- Rotherham [(Rotherham$Default.LA=="Rotherham"),]
write.table (Rotherham, file="~/Reports/2.Ad-hoc-reports/2023.04.18_Rotherham_Negar.csv", row.names=F, sep=",")
