...
setwd("~/Reports/1.Monthly_Reports/Performance_Reports/2023/2023_05")
...
orders = read.csv("20230605_sti_order_report.csv")


Treatments = read.csv("20230605_CT_Treatments.csv")
COC = read.csv("20230605_COC.csv")
POP = read.csv("20230605_POP.csv")
ECFuture = read.csv("20230605_ECFuture.csv")
ECNow = read.csv("20230605_ECNow.csv")
...
invSTI = read.csv("20230605_sti_invoicing_primary.csv")
...
write.table (freetesting4, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023.05 freetesting.PHE.ImpactPrEP.csv", row.names=F, sep=",")
...
write.table (Data_Ireland, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023.06.05_Ireland_STI.csv", row.names=F, sep=",")
# END Ireland Justin----



#export data to csv (export the data of the ordered file). Use double \\ when setting destination file----
write.table (Data_Berkshire, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Berkshire STI.csv", row.names=F, sep=",")
write.table (Data_Bromley, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Bromley STI.csv"
             , row.names=F, sep=",")

write.table (Data_Buckinghamshire, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Buckinghamshire STI.csv", row.names=F, sep=",")

write.table (Data_Cornwall, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Cornwall_Southe_Blackb STI.csv", row.names=F, sep=",")


write.table (Data_DerbyshireDerby, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month DerbyshireDerby STI.csv", row.names=F, sep=",")
write.table (Data_Dorset, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Dorset STI.csv", row.names=F, sep=",")
write.table (Data_Essex, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Essex STI.csv", row.names=F, sep=",")
write.table (Data_Thurrock, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Thurrock STI.csv", row.names=F, sep=",")
write.table (Data_Hillingdon, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Hillingdon STI.csv", row.names=F, sep=",")
write.table (Data_LLR.MPFT, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month LLR.MPFT STI_Hep.csv", row.names=F, sep=",")
write.table (Data_NIreland, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month NIreland STI.csv", row.names=F, sep=",")
write.table (Data_Worces_Hereford, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Worces_Hereford STI.csv", row.names=F, sep=",")
...
write.table (Treatment.Berkshire, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Berkshire Treatments.csv", row.names=F, sep=",")
write.table (Treatment.Bromley, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Bromley Treatments.csv", row.names=F, sep=",")
write.table (Treatment.DerbyshireDerby, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month DerbyshireDerby Treatments.csv", row.names=F, sep=",")
write.table (Treatment.Dorset, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Dorset Treatments.csv", row.names=F, sep=",")
write.table (Treatment.Essex, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Essex Treatments.csv", row.names=F, sep=",")
write.table (Treatment.Thurrock, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Thurrock Treatments.csv", row.names=F, sep=",")
write.table (Treatment.LLR.MPFT, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month LLR.MPFT Treatments.csv", row.names=F, sep=",")
write.table (Treatment.NIreland, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month NIreland Treatments.csv", row.names=F, sep=",")
...
write.table (COC_DerbyshireDerby, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month DerbyshireDerby COC.csv", row.names=F, sep=",")
write.table (POP_DerbyshireDerby, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month DerbyshireDerby POP.csv", row.names=F, sep=",")
...
write.table (COC_LLR.MPFT, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month LLR.MPFT COC.csv", row.names=F, sep=",")
write.table (POP_LLR.MPFT, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month LLR.MPFT POP.csv", row.names=F, sep=",")
write.table (COC_Cornwall, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Cornwall_Southe_Blackb COC.csv", row.names=F, sep=",")
write.table (POP_Cornwall, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month Cornwall_Southe_Blackb POP.csv", row.names=F, sep=",")
...
write.table (invSTIessexThurrMonth, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month invoic_EssexThurrock.csv", row.names=F, sep=",")
write.table (invSTIWorcestMonth, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_05/BackingData/2023 Month invoic_Worcestershire.csv", row.names=F, sep=",")
