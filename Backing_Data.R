...
write.table (Data_Dorset, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_07/BackingData/2023 Month Dorset STI.csv", row.names=F, sep=",")
...
write.table (Treatment.Dorset, file="~/Reports/1.Monthly_Reports/Invoicing/2023/2023_07/BackingData/2023 Month Dorset Treatments.csv", row.names=F, sep=",")
