...
Ctad1 <- Ctad [((Ctad$Created.at.month.year=="2023-04"| Ctad$Created.at.month.year=="2023-05"| Ctad$Created.at.month.year=="2023-06")
...
write.table (Ctad3Long1, file="~/Reports/NHS_Reports/CTAD/2023/YGMDR_Q2_2023.csv", row.names=F, sep=",")
