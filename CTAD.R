...
Ctad1 <- Ctad [((Ctad$Created.at.month.year=="2022-01"| Ctad$Created.at.month.year=="2022-02"| Ctad$Created.at.month.year=="2022-03")
...
write.table (Ctad3Long1, file="\\Users\\ElenaArdinesTomas\\Documents\\Reports\\NHS_Reports\\CTAD\\2022\\YGMDR_Q1_2022.csv", row.names=F, sep=",")
